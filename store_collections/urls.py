...
urlpatterns = [
    ...
    path('get-primary-collections/<int:id>/', views.get_primary_collections),
    path('get-secondary-collections/<int:id>/', views.get_secondary_collection),
    path('get-tertiary-collections/<int:id>/', views.get_tertiary_collections),
    path('get-customer-collections/<int:id>/', views.get_customer_collection),


    path('edit-primary-collections/<int:id>/', views.edit_primary_collection),
    path('edit-secondary-collections/<int:id>/', views.edit_secondary_collection),
    ...
    path('delete-primary-collections/<int:id>/', views.delete_primary_collection),
    path('delete-secondary-collections/<int:id>/', views.delete_secondary_collection),
    path('delete-tertiary-collections/<int:id>/', views.delete_tertiary_collection),
    path('delete-customer-collections/<int:id>/', views.delete_customer_collection),
]
