    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_title', models.CharField(blank=True, default='Collection Title', max_length=150, null=True)),
                ('collection_subtitle', models.CharField(blank=True, default='Collection Subtitle', max_length=100, null=True)),
                ('collection_image', models.ImageField(blank=True, default='../default_images/profile_picture.jpg', null=True, upload_to='images/')),
