...
class PrimaryProduct(BaseProduct):
    collection_id = models.ForeignKey(PrimaryCollection, on_delete=models.CASCADE)
...
class SecondaryProduct(BaseProduct):
    collection_id = models.ForeignKey( SecondaryCollection, on_delete=models.CASCADE)
...
class TertiaryProduct(BaseProduct):
    collection_id = models.ForeignKey(TertiaryCollection, on_delete=models.CASCADE)
